...
# KPQueryCacher.list_cached_queries' table columns (trapi_query_cacher.py @ 9485431)
KP_CACHE_COLUMN_DATA = [
    {
        "key": "kp_query_id",
        "title": "id",
        "title_hover": "Integer identifier of the cached KP query",
    },
    {
        "key": "status",
        "title": "status",
        "title_hover": "Status of the cached KP query",
    },
    {
        "key": "query_age_hr",
        "title": "age hr",
        "title_hover": "Age of the cache entry in hours",
        "red_if_greater_than_stat": "age_before_refresh_hr",
    },
    {
        "key": "kp_curie",
        "title": "KP curie",
        "title_hover": "CURIE of the target KP",
        "cell_hover_key": "query_url",
    },
    {
        "key": "first_request_datetime",
        "title": "first datetime",
        "title_hover": "Datetime of the first attempt at this query",
    },
    {
        "key": "last_request_datetime",
        "title": "last datetime",
        "title_hover": "Datetime of the most recent request of this query",
    },
    {
        "key": "first_query_elapsed",
        "title": "first elapsed",
        "title_hover": "Elapsed of the first query attempt in seconds",
        "red_if_greater_than_value": 5,
    },
    {
        "key": "first_query_http_code",
        "title": "first code",
        "title_hover": "HTTP code of the first query attempt (-1 is a timeout)",
        "red_if_not_equal_to_value": 200,
    },
    {
        "key": "first_query_n_results",
        "title": "first n results",
        "title_hover": "Number of TRAPI results in first query attempt",
    },
    {
        "key": "n_requests",
        "title": "n requests",
        "title_hover": "Number of total ARAX requests for this query",
    },
    {
        "key": "last_attempted_refresh_datetime",
        "title": "last attempted datetime",
        "title_hover": "Datetime of the last attempt to refresh this query",
    },
    {
        "key": "last_successful_refresh_datetime",
        "title": "last success datetime",
        "title_hover": "Datetime of the last successful attempt to refresh this query",
    },
    {
        "key": "n_successful_refreshes",
        "title": "n success",
        "title_hover": "Number of successful refreshes",
    },
    {
        "key": "n_failed_refreshes",
        "title": "n failed",
        "title_hover": "Number of failed refreshes",
        "red_if_greater_than_value": 0,
    },
    {
        "key": "last_refresh_elapsed",
        "title": "last elapsed",
        "title_hover": "Elapsed time of the last successfulrefresh in seconds",
        "red_if_greater_than_value": 5,
    },
    {
        "key": "last_attempted_refresh_http_code",
        "title": "last attemptcode",
        "title_hover": "HTTP code of the last refresh attempt (-1 is a timeout)",
        "red_if_not_equal_to_value": 200,
    },
    {
        "key": "last_refresh_http_code",
        "title": "last code",
        "title_hover": "HTTP code of the last successful refresh (-1 is a timeout)",
        "red_if_not_equal_to_value": 200,
    },
    {
        "key": "last_refresh_n_results",
        "title": "last n results",
        "title_hover": "Number of TRAPI results in the most recent successful refresh attempt",
    },
    {
        "key": "n_refresh_same_results",
        "title": "n same",
        "title_hover": "Number of refreshes that yielded the same results as the most recent successful refresh",
    },
    {
        "key": "n_refresh_different_results",
        "title": "n diff",
        "title_hover": "Number of refreshes that yielded different results as the most recent successful refresh",
        "red_if_greater_than_value": 0,
    },
...
# trapi_query_cacher.AGE_BEFORE_REFRESH_HOURS
AGE_BEFORE_REFRESH_HOURS = 6.0


def kp_cache_listing() -> dict:
    """KPQueryCacher.list_cached_queries for an empty cache: Shepherd has no KP
    cache (DEC-3; the UI's KP-cache view is accepted as broken)."""
    cache_stats = {
        "n_cached_queries": 0,
        ...
        "http_status_codes": {},
        "total_cache_size_MiB": 0.0,
    }
    return {
        "cache_stats": cache_stats,
        "column_data": KP_CACHE_COLUMN_DATA,
        "cache_data": [],
    }
